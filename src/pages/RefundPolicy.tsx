...
const RefundPolicy: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <Section>
        <Paragraph>
          At {COMPANY_INFO.name}, we stand behind the quality of our Illustration courses and want you to be satisfied with your learning experience. 
          This refund policy outlines the terms and conditions for refunds on our digital Illustration course purchases.
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <Paragraph>
          We offer a 7-day satisfaction guarantee on all Illustration course purchases. You may request a refund within 7 days 
      ...
      <Section>
        ...
        <Paragraph>
          To request a refund for your Illustration course purchase:
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          You will see "ILLUSTRATION COURSES" or "ILLUSTAR-COURSE.COM" as the refund descriptor on your statement.
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          If you have any questions or concerns we are happy to assist you through <br></br>email: {CONTACT_INFO.email}
        </Paragraph>
        <Paragraph>
          Refund requests must be made within thirty (30) days of your purchase date.
        </Paragraph>
        <Paragraph>
          If you are not satisfied with the product, you may call or email customer service to request a refund within 30 days of purchase. All refunds should appear back on your credit card in 5–7 business days after calling customer service at {CONTACT_INFO.phoneFormatted} or emailing {CONTACT_INFO.email} to cancel your order and request a refund. We stand by our products and accept returns within 30 days of purchase.
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          • Request a course credit for a different Illustration course that better suits your needs<br/>
